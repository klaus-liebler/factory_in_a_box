...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, SYNC2_Pin|INFOLED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ETHERCAT_RESET_GPIO_Port, ETHERCAT_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ETH_RESET_GPIO_Port, ETH_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, VALVE1_Pin|VALVE3_Pin|VALVE2_Pin|STEPPER1_DIR_Pin
  ...
  /*Configure GPIO pins : SYNC2_Pin INFOLED_Pin */
  GPIO_InitStruct.Pin = SYNC2_Pin|INFOLED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : PC13_Pin TOF1_IRQ_Pin LIGHTBARRIER1_Pin LIGHTBARRIER2_Pin
                           LIGHTBARRIER3_Pin PC11 */
  GPIO_InitStruct.Pin = PC13_Pin|TOF1_IRQ_Pin|LIGHTBARRIER1_Pin|LIGHTBARRIER2_Pin
                          |LIGHTBARRIER3_Pin|GPIO_PIN_11;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : ETHERCAT_RESET_Pin */
  GPIO_InitStruct.Pin = ETHERCAT_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ETHERCAT_RESET_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : RGBSENS_IRQ_Pin TOF2_IRQ_Pin */
  GPIO_InitStruct.Pin = RGBSENS_IRQ_Pin|TOF2_IRQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : TOF3_IRQ_Pin PA8_Pin */
  GPIO_InitStruct.Pin = TOF3_IRQ_Pin|PA8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : VALVE1_Pin VALVE3_Pin VALVE2_Pin STEPPER1_DIR_Pin
                           STEPPER2_DIR_Pin */
  GPIO_InitStruct.Pin = VALVE1_Pin|VALVE3_Pin|VALVE2_Pin|STEPPER1_DIR_Pin
                          |STEPPER2_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : CURRENT_ALERT_Pin */
