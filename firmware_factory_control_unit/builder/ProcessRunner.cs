// Kleiner Kindprozess-Helfer, von allen Phasen genutzt, die externe Tools aufrufen (openssl,
// STM32_Programmer_CLI, cmake, node/vite, git). Faengt ENOENT/nicht-0-Exit in eine lesbare
// Exception statt .NET's Standard-Win32Exception/nicht abgefangenen Exit-Code durchzureichen.
...
public static class ProcessRunner
{
	...
	// Wie Run(), aber stdout als rohe Bytes (fuer DER-Binaerausgabe von openssl) -- BaseStream statt
	// StandardOutput (TextReader), um Encoding-Korruption der Binaerdaten zu vermeiden.
	...
	// Wie Run(), aber stdout/stderr werden direkt an die Konsole durchgereicht (fuer cmake/
	// STM32_Programmer_CLI-Aufrufe, deren Live-Ausgabe der Nutzer sehen soll -- Pendant zu
	// execFileSync's stdio:"inherit").
